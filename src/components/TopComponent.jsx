...
const TopComponent = () => {
  return (
    <div id='about' className="bg-black min-h-screen flex flex-col md:flex-row items-center justify-center">
      {/* Image Section */}
      ...
      <div className="flex flex-col w-full md:w-1/2 p-4 opacity-0 animate-[slide-right_1.5s_ease-out_forwards]">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center flex-wrap gap-4 p-4">
          ...
          <button
            className="relative overflow-hidden bg-cyan-400 rounded-2xl min-w-[200px] min-h-12 px-6 py-3 font-semibold 
             transform transition-transform duration-500 hover:scale-110 hover:cursor-pointer hover:text-white
             hover:bg-cyan-500"
            onClick={() => window.open('https://drive.google.com/file/d/14FxsXxokEUz4hqluB2xeU9mYJrZe-eSl/view?usp=sharing', '_blank')}
          >
            Resume (Open to work)
          </button>
